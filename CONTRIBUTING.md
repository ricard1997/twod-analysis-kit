...
We welcome all contributions to 2D Analysis!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/monjegroup/twod-analysis-kit/issues)
...
The second two options both involve making a [pull request](https://github.com/monjegroup/twod-analysis-kit/pulls) .
