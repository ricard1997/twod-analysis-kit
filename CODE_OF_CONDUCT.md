...
The 2D Analysis *Code of Conduct* sets the rules for the behavior of
every member in the 2D Analysis community so that everyone can
...
2D Analysis is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make 2D Analysis a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and 2D Analysis is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of 2D Analysis comes from its varied community
...
reported by contacting the project team at 'vmonje@buffalo.edu'. The project team will
